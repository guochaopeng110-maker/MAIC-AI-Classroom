...
function HomePage() {
  ...
  const hasUsableProvider = mounted ? hasUsableLLMProvider(providersConfig) : false;
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      ...
      />
      <ManualSheet isOpen={manualOpen} onClose={() => setManualOpen(false)} />
      ...
      >
        ...
        <motion.img
          ...
          className="h-12 md:h-16 mb-2 -ml-2 md:-ml-3 dark:drop-shadow-[0_0_12px_rgba(255,255,255,0.5)]"
        />
...
function GreetingBar() {
  ...
  const avatar = mounted ? storeAvatar : AVATAR_OPTIONS[0];
  const nickname = mounted ? storeNickname : '';
  const bio = mounted ? storeBio : '';
